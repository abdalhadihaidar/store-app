...
Product.init({
    ...
    package: { type: sequelize_1.DataTypes.INTEGER, allowNull: false, defaultValue: 0 },
    numberperpackage: { type: sequelize_1.DataTypes.INTEGER, allowNull: false, defaultValue: 0 },
