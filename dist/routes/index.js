...
const imageUpload_routes_1 = __importDefault(require("./imageUpload.routes"));
...
router.use('/upload', imageUpload_routes_1.default);
router.use('/stats', stats_routes_1.default);
router.use('/stores', store_routes_1.default);
router.use('/returns', order_routes_1.default);
