 ...
 */
router.get('/:id/calculate-packages', product_controller_1.ProductController.calculatePackages);
/**
 * @swagger
 * /products/quantity:
 *   post:
 ...
 */
router.post('/quantity', product_controller_1.ProductController.createProductWithQuantity);
