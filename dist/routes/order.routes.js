 ...
 */
router.get('/returns', (0, auth_middleware_1.authMiddleware)(['admin']), order_controller_1.OrderController.getAllReturns);
/**
 * @swagger
 * /orders/{id}:
 *   get:
 ...
 */
router.post('/:id/returns', (0, auth_middleware_1.authMiddleware)(['admin', 'client']), order_controller_1.OrderController.createReturn);
/**
 * @swagger
 * /orders/{id}/details:
 *   get:
 ...
 */
router.get('/:id/details', (0, auth_middleware_1.authMiddleware)(['admin', 'client']), order_controller_1.OrderController.getOrderDetails);
/**
 * @swagger
 * /orders/user/{userId}:
 *   get:
